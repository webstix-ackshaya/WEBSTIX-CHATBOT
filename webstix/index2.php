...
<script>
    $(document).ready(function(){
            $(".button-86, #send-btn").click(function()
        {             
            $button_clicked=this.name;
                $id_clicked=this.id;
                $msg = '<div class="user-inbox inbox"><div class="msg-header"><p>'+ $button_clicked +'</p></div></div>';
                $(".form").append($msg);
                ...
                $.ajax({
                    url: 'botwork2.php',
                    type: 'POST',
                    data: {'texts': $id_clicked ,'text1':$button_clicked,'text2':$value},
